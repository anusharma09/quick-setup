...
namespace CCEJobs {
    ...
    [global::System.Xml.Serialization.XmlRootAttribute("AtefDataSet10")]
    [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")]
    public partial class AtefDataSet10 : global::System.Data.DataSet {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        protected AtefDataSet10(global::System.Runtime.Serialization.SerializationInfo info, global::System.Runtime.Serialization.StreamingContext context) : 
        ...
        public override global::System.Data.DataSet Clone() {
            AtefDataSet10 cln = ((AtefDataSet10)(base.Clone()));
            cln.InitVars();
        ...
        private void InitClass() {
            this.DataSetName = "AtefDataSet10";
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/AtefDataSet10.xsd";
        ...
        public static global::System.Xml.Schema.XmlSchemaComplexType GetTypedDataSetSchema(global::System.Xml.Schema.XmlSchemaSet xs) {
            AtefDataSet10 ds = new AtefDataSet10();
...
namespace CCEJobs.AtefDataSet10TableAdapters {
    ...
    public partial class tblBidBondTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = @"SELECT     j.EstimateNumber, j.JobNumber, j.JobName, m.Description AS ProjectManager, e.Description AS Estimator, s.Description AS Superintendent, 
                      j.BillingRep, u.Name AS CustomerName, 
                      CASE JobChangeOrderApprovedAmount WHEN 0 THEN JobChangeOrderRequestedAmount ELSE JobChangeOrderApprovedAmount END AS ApprovedAmount,
                       p.JobCostCodeType, p.JobCostCodePhase, p.CostCode, d.Description AS CostCodeDescription, ISNULL(d.Quantity, 0) AS Quantity, ISNULL(d.Hours, 0) 
                      AS Hours, ISNULL(d.Cost, 0) AS Cost
FROM         tblJob AS j LEFT OUTER JOIN
                      tblProjectManager AS m ON j.ProjectManagerID = m.ProjectManagerID LEFT OUTER JOIN
                      tblEstimator AS e ON j.EstimatorID = e.EstimatorID LEFT OUTER JOIN
                      tblSuperintendent AS s ON j.SuperIntendentID = s.SuperintendentID LEFT OUTER JOIN
                      tblJobChangeOrder AS C ON j.JobID = C.JobID LEFT OUTER JOIN
                      tblCustomer AS u ON j.CustomerID = u.CustomerID LEFT OUTER JOIN
                      tblJobCostCode AS d ON C.JobChangeOrderID = d.JobChangeOrderID LEFT OUTER JOIN
                      tblJobCostCodePhase AS p ON d.JobCostCodePhaseID = p.JobCostCodePhaseID
WHERE     (C.JobChangeOrderID = 0)";
        ...
        public virtual int Fill(AtefDataSet10.tblBidBondDataTable dataTable) {
        ...
        public virtual AtefDataSet10.tblBidBondDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            AtefDataSet10.tblBidBondDataTable dataTable = new AtefDataSet10.tblBidBondDataTable();
