   ...
   public class Reports
    {
       ...
       //
       //
       public static void JobDashboardCost(string sort, string filer, DataTable jobDashboardCost)
       {
           try
           {
       ...
       public static void JobInvoiceDetailAging(DataSet jobInvoiceDetailAgingDataSet)
       {
        ...
        public static void JobInvoiceDetail(string jobID, string JobNumber, string jobName, DataSet jobInvoiceDetailDataSet, string filter)
        {
            try
            {
                ...
                if (jobInvoiceDetailDataSet.Tables.Count > 1 && jobInvoiceDetailDataSet.Relations[0].RelationName == "Payments")
                {
       ...
       public static void JobLogListAll(string where, string startDate, string endDate)
       {
        ...
        public static void WeeklyEstimateBudget()
        {
            try
            {
                DataTable table;
        ...
        public static void WeeklyEstimateOpenPending(string endDate, string reportType)
        {
            try
            {
                DataTable table;
