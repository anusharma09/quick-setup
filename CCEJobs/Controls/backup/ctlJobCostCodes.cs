...
namespace CCEJobs.Controls
{
    ...
    public partial class ctlJobCostCodes : UserControl
    {
        ...
        {
            if (jobChangeOrders.Tables[0].Rows.Count > 1) //|| gridView1.RowCount != 0)
            {
                panTemplate.Visible = false;
                return;
            }
        ...
        private void GetJobChangeOrders()
        {
            try
            {
                ...
                jobChangeOrders = JobChangeOrder.GetJobChangeOrders(jobID);
                jobChangeOrders.Relations[0].RelationName = "Budget Code";
                this.grdChangeOrder.DataSource = jobChangeOrders;
                this.grdChangeOrder.DataMember = "Main";

                if (jobChangeOrders.Tables[0].Rows.Count > 0)
                {
                    ...
                    grdChangeOrderView.Columns["JobChangeOrderOwnerNumber"].Caption = "Owner C/O No";
                    ...
                    grdChangeOrderView.Columns["JobChangeOrderCCENumber"].Caption = "CCE PCO No";
        ...
        private void GetCurrnetChangeOrderDetail()
        {
            ...
            if (grdChangeOrderView.SelectedRowsCount != 0)
            {
                ...
                {
                    if (jobChangeOrders.Tables[0].Rows.Count > 0 && grdChangeOrderView.FocusedRowHandle != -999998)
                    {
                        r = jobChangeOrders.Tables[0].Rows[0];
                    }
                }
        ...
        private void grdChangeOrderView_MasterRowExpanded(object sender, DevExpress.XtraGrid.Views.Grid.CustomMasterRowEventArgs e)
        {

            GridView grdChangeOrderView = sender as GridView;
            GridView view = grdChangeOrderView.GetDetailView(e.RowHandle, e.RelationIndex) as GridView;
            view.BeginDataUpdate();
            view.BestFitColumns();
            view.Columns["JobChangeOrderCommentID"].Visible = false;
            view.Columns["JobChangeOrderID"].Visible = false;
            ...
            view.Columns["Comment"].ColumnEdit = repComment1;
            ...
            switch (result)
            {
                ...
                case DialogResult.Yes:
                    ...
                    if (valid)
                    {
                        ...
                        e.Valid = true;
                        grdChangeOrderComment.RefreshData();
        ...
        private void btnProcess_Click(object sender, EventArgs e)
        {
            ...
            {
                DataTable t = JobCost.GetPhaseCodes(cboPhase.EditValue.ToString()).Tables[0];
